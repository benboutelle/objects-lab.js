...
//Code here
favoriteThings.car = `optimus prime`
favoriteThings.show = `Martha & Snoop's Potluck Party Challenge`
...
//Code here
 favoriteThings.food = `chicken nuggys`  
...
function totalPopulation (object) {
  let {utah,cali,texas,arizona} = object
...
function ingredients(object){
  let {prop1,prop2,prop3} = object

let ingarray = []
ingarray.push(prop1,prop2,prop3)
...
class cat {
  constructor(name,age,color){
    this.name = `satanspawn`
    this.age = 666
    this.color = `black`
  }
}
const satanspawn = new cat('satanspawn', 666, 'black')

console.log(`My cats name is ${satanspawn.name} `)
